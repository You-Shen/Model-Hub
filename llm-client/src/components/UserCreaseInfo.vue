    ...
    <main class="container mx-auto px-4 py-4">
      <div class="admin-content bg-white rounded-2xl shadow-xl p-6" style="max-height: calc(100vh - 160px);">
        <div class="flex flex-col items-center mb-4">
          ...
          <h2 class="text-2xl font-bold text-gray-800">当月新增用户信息</h2>
          <p class="text-gray-500 text-sm">查看系统新增用户数据</p>
        </div>
          ...
          >
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div>
                ...
                <p class="font-medium">{{ user.create_time }}</p>
              </div>
            </div>
          </div>
        </div>
        <div v-else class="text-center py-8">
          ...
          <p class="text-gray-500">暂无用户信息</p>
        </div>
      </div>
    </main>
