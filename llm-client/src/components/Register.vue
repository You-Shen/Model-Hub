      ...
      <div class="login-card rounded-2xl overflow-hidden w-full max-w-md">
        <div class="p-8">
          ...
          <div class="text-center mb-8">
            <h1 class="text-3xl font-bold text-gray-800 mb-2">注册新账号</h1>
            <p class="text-gray-500">加入我们，开启AI体验之旅</p>
          </div>
              ...
              <div class="relative">
                ...
                <div class="flex">
                  ...
                  <button
                      ...
                      @click="sendAuthCode"
                      class="ml-2 px-4 py-1 rounded-lg bg-purple-600 text-white hover:bg-purple-700 transition disabled:bg-gray-400 disabled:cursor-not-allowed text-sm"
                  >
                    {{ sendButtonText }}
                  </button>
                </div>
          ...
          <div class="mt-8 text-center text-sm text-gray-500">
            已有账号?
            <router-link to="/login" class="text-purple-600 font-medium hover:text-purple-800 transition">立即登录</router-link>
          </div>
        </div>
